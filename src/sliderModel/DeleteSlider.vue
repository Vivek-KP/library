<template>
    <div ref="deleteModel" class="modal fade" data-bs-backdrop="static" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
...
const onDelete = () =>{
    axios.delete(`http://127.0.0.1:5000/member?id=${props.memberId}`).then(()=>{
    // modalInstance.value.hide()
    emit('onDelete')
    }).catch(()=>{
